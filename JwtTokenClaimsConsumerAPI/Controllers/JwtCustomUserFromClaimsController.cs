...
namespace JwtTokenClaimsConsumerAPI.Controllers
{
    ...
    public class JwtCustomUserFromClaimsController : ControllerBase
    {
        ...
        public JwtCustomUserFromClaimsController(ILogger<JwtCustomUserFromClaimsController> logger, IOptions<AuthorizedAccountEndpointOptions> options)
        {
            _logger = logger;
    ...
    public class ErrorController : ControllerBase
    {
        ...
        public IActionResult Error()
        {
            ...
            if (exception is UnauthorizedAccessException)
            {
                ...
                return Problem(detail: "Unauthorized access", title: exception.Message);
            }

            Response.StatusCode = StatusCodes.Status500InternalServerError;
            return Problem(detail: context?.Error.StackTrace,  // You may not want to expose the stack trace
